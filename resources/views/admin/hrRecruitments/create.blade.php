        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.hrRecruitment.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.hr-recruitments.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('mobilenumber') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mobilenumber" id="mobilenumber" value="{{ old('mobilenumber', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('called') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="called" id="called">
                                ...
                                @foreach(App\Models\HrRecruitment::CALLED_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('called', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('interview_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="interview_date" id="interview_date" value="{{ old('interview_date') }}">
